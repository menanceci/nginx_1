...
1. Install the NGINX Ingress Operator following the [instructions](https://github.com/nginxinc/nginx-ingress-operator-helm/blob/main/docs/installation.md).
1. Create the default server secret and SecurityContextConstraint as oulined in the [instructions](https://github.com/nginxinc/nginx-ingress-operator-helm/blob/main/docs/installation.md).
